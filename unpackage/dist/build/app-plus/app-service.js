...
var z=gz$gwx_11()
var oBB=_mz(z,'uni-indexed-list',['bind:__l',0,'bind:click',1,'data-event-opts',1,'options',2,'otherHeight',3,'showSelect',4,'vueId',5],[],e,s,gg)
_(r,oBB)
return r
}
...
var xIB=_mz(z,'me-qrcode',['background',1,'bind:__l',1,'bind:result',2,'cid',3,'class',4,'data-event-opts',5,'data-ref',6,'foreground',7,'icon',8,'iconSize',9,'loadMake',10,'lv',11,'onval',12,'pdground',13,'size',14,'unit',15,'usingComponents',16,'val',17,'vueId',18],[],e,s,gg)
_(oHB,xIB)
}
oHB.wxXCkey=1
oHB.wxXCkey=3
...
var eTB=_mz(z,'uni-swipe-action',['bind:__l',4,'bind:click',1,'data-event-opts',2,'options',3,'vueId',4,'vueSlots',5],[],lQB,oPB,gg)
_(aRB,eTB)
return aRB
}
oNB.wxXCkey=4
...
var oXB=_mz(z,'chart_-weather-line',['bind:__l',2,'canvasHightData',1,'canvasLowData',2,'canvasMaximum',3,'canvasMinimum',4,'canvasNumData',5,'class',6,'vueId',7],[],e,s,gg)
_(oVB,oXB)
var fYB=_mz(z,'uni-drawer',['bind:__l',10,'bind:close',1,'class',2,'data-event-opts',3,'mode',4,'visible',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var cZB=_v()
_(fYB,cZB)
var h1B=function(c3B,o2B,o4B,gg){
var a6B=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2],[],c3B,o2B,gg)
var t7B=_mz(z,'uni-swipe-action',['bind:__l',25,'bind:click',1,'data-event-opts',2,'options',3,'vueId',4,'vueSlots',5],[],c3B,o2B,gg)
_(a6B,t7B)
_(o4B,a6B)
return o4B
}
cZB.wxXCkey=4
_2z(z,20,h1B,e,s,gg,cZB,'item','index','index')
_(oVB,fYB)
xWB.wxXCkey=1
_(r,oVB)
return r
...
var z=gz$gwx_20()
var b9B=_mz(z,'chart_-weather-line',['bind:__l',0,'class',1,'vueId',1],[],e,s,gg)
_(r,b9B)
return r
}
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/main/main"],{"55ee":function(e,o,i){"use strict";i.r(o);var a=i("5f29"),c=i.n(a);for(var n in a)"default"!==n&&function(e){i.d(o,e,function(){return a[e]})}(n);o["default"]=c.a},"5f29":function(e,o,i){"use strict";(function(e){Object.defineProperty(o,"__esModule",{value:!0}),o.default=void 0,i("bc83");var a={data:function(){return{picList:["https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554565147883&di=94652bd7f8e89e9c512971544994cbc2&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F0192e658b8d8aea801219c77111f0a.png%40900w_1l_2o_100sh.jpg","https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554565147883&di=94652bd7f8e89e9c512971544994cbc2&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F0192e658b8d8aea801219c77111f0a.png%40900w_1l_2o_100sh.jpg","https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554565147883&di=94652bd7f8e89e9c512971544994cbc2&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F0192e658b8d8aea801219c77111f0a.png%40900w_1l_2o_100sh.jpg","https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554565147883&di=94652bd7f8e89e9c512971544994cbc2&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F0192e658b8d8aea801219c77111f0a.png%40900w_1l_2o_100sh.jpg","https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1554565147883&di=94652bd7f8e89e9c512971544994cbc2&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F0192e658b8d8aea801219c77111f0a.png%40900w_1l_2o_100sh.jpg"],indicatorColor:"#fff",indicatorActiveColor:"#00a2e9",indicatorDots:!0,autoplay:!0,interval:5e3,duration:1e3,toolData:[{label:"天气预报",type:"wetherForecast",icon:"icon-swticontianqi",color:["#2481b4","#87c6ea"]},{label:"设置闹钟",type:"todayHeadline",icon:"icon-naozhong",color:["#49bff3","#9df8f7"]},{label:"扫一扫",type:"scan",icon:"icon-saoyisao",color:["#f57936","#ffdb35"]},{label:"二维码生成",type:"qrCode",icon:"icon-erweima",color:["#5fd8c6","#61e6e0"]},{label:"支付",type:"pay",icon:"icon-ic_paid",color:["#fd798d","#ffb3a6"]},{label:"推送",type:"push",icon:"icon-fasongxinxi",color:["#a294f7","#9cb1f7"]},{label:"分享",type:"share",icon:"icon-fenxiang",color:["#61c566","#a9e28b"]},{label:"发送模板消息",type:"todayHeadline",icon:"icon-message",color:["#ef9a3c","#f8c568"]},{label:"通讯录",type:"callPhone",icon:"icon-shoujidadianhua",color:["#c477d2","#dd87cd"]},{label:"地图定位",type:"todayHeadline",icon:"icon-dituguanli",color:["#5eb8f1","#6fd1ef"]},{label:"新华字典",type:"xinhuaDictionary",icon:"icon-xinhuazidian",color:["#4facfe","#00f2fe"]},{label:"成语字典",type:"idiomsDictionary",icon:"icon-chengyucidian",color:["#43e97b","#38f9d7"]},{label:"驾照题库",type:"driverTest",icon:"icon-jiazhaodengji",color:["#00b9a3","#00cc9a"]},{label:"历史今天",type:"historyToday",icon:"icon-lishi",color:["#4e95ff","#54bdfa"]},{label:"文字转换",type:"textConversion",icon:"icon-zhuanhuan",color:["#87e3e4","#59c4f1"]},{label:"星座运势",type:"constellationChart",icon:"icon-xingzuo",color:["#2af598","#009efd"]},{label:"周公解梦",type:"zgInterprets",icon:"icon-zuomeng",color:["#18bcf4","#ade4fd"]},{label:"今日头条",type:"todayHeadline",icon:"icon-xinwen",color:["#58a0fd","#c8c6ff"]},{label:"语音读报",type:"todayHeadline",icon:"icon-xinwen",color:["#577ff3","#abb1f6"]},{label:"xxx",type:"todayHeadline",icon:"icon-xinwen",color:["#e858a2","#ec8fc3"]},{label:"xxx",type:"todayHeadline",icon:"icon-xinwen",color:["#2f6af8","#51c0fa"]},{label:"xxx",type:"todayHeadline",icon:"icon-xinwen",color:["#eb5d43","#ef9181"]},{label:"xxx",type:"todayHeadline",icon:"icon-xinwen",color:["#ea4646","#ef7873"]},{label:"xxx",type:"todayHeadline",icon:"icon-xinwen",color:["#f09b3d","#f9d267"]}]}},methods:{changeIndicatorDots:function(e){this.indicatorDots=!this.indicatorDots},changeAutoplay:function(e){this.autoplay=!this.autoplay},intervalChange:function(e){this.interval=e.target.value},durationChange:function(e){this.duration=e.target.value},toTool:function(o){var i=JSON.parse(o.currentTarget.dataset.items),a=i.label,c=i.type;e.navigateTo({url:"/views/"+c+"?label="+a})}}};o.default=a}).call(this,i("6e42")["default"])},"7c83":function(e,o,i){"use strict";i.r(o);var a=i("da37"),c=i("55ee");for(var n in c)"default"!==n&&function(e){i.d(o,e,function(){return c[e]})}(n);var t=i("2877"),l=Object(t["a"])(c["default"],a["a"],a["b"],!1,null,null,null);o["default"]=l.exports},da37:function(e,o,i){"use strict";var a=function(){var e=this,o=e.$createElement,i=(e._self._c,e.__map(e.toolData,function(o,i){var a=JSON.stringify(o);return{$orig:e.__get_orig(o),g0:a}}));e.$mp.data=Object.assign({},{$root:{l0:i}})},c=[];i.d(o,"a",function(){return a}),i.d(o,"b",function(){return c})}},[["76ab","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["views/callPhone"],{"1b7a":function(t,e,n){"use strict";var i=function(){var t=this,e=t.$createElement;t._self._c},o=[];n.d(e,"a",function(){return i}),n.d(e,"b",function(){return o})},2963:function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0,n("deca");var i=o(n("f903"));function o(t){return t&&t.__esModule?t:{default:t}}var s=t.getSystemInfoSync().platform,a={onLoad:function(e){e.label&&t.setNavigationBarTitle({title:e.label})},data:function(){return{scrollViewId:"wo",letter:"",boxTop:0,barHeight:0,minHeight:0,hidden:!0,contacts:[],contactItems:[],isSearch:!1,isShow:!1}},methods:{getCur:function(t){this.hidden=!1,this.letter=t.target.id},setCur:function(t){this.hidden=!0,this.letter=t.target.id},tMove:function(t){var e=t.touches[0].clientY,n=this.boxTop;if(e>n){var i=Math.floor((e-n)/this.barHeight);i<this.contacts.length&&(this.letter=this.contacts[i].letter,this.scrollViewId=this.letter)}},tStart:function(){this.hidden=!1},tEnd:function(){this.hidden=!0},initContacts:function(){var t=this;plus.contacts.getAddressBook(plus.contacts.ADDRESSBOOK_PHONE,function(e){e.find(["displayName","phoneNumbers"],function(e){for(var n=[],o=0;o<e.length;o++)if(e[o].phoneNumbers.length>0){var s={name:e[o].displayName,phone:e[o].phoneNumbers[0].value};n.push(s)}t.contacts=i.default.paixu(n),t.contacts.sort(function(t,e){return t.letter.charCodeAt(0)-e.letter.charCodeAt(0)}),t.contactItems=JSON.parse(JSON.stringify(t.contacts))},function(e){t.onAddressBookSetting()})},function(e){t.onAddressBookSetting()})},onAddressBookSetting:function(){this.isShow||(this.isShow=!0,t.showModal({title:"提示",content:"APP通讯录权限没有开启，是否开启？",success:function(e){if(e.confirm)if("ios"==s){var n=plus.ios.import("UIApplication"),i=plus.ios.import("NSURL"),o=i.URLWithString("app-settings:"),a=n.sharedApplication();a.openURL(o),plus.ios.deleteObject(o),plus.ios.deleteObject(i),plus.ios.deleteObject(a)}else{var r=plus.android.runtimeMainActivity(),c=plus.android.importClass("android.os.Build"),l=plus.android.importClass("android.content.Intent");if(c.VERSION.SDK_INT>=9){var u=new l("android.settings.APPLICATION_DETAILS_SETTINGS"),d=plus.android.importClass("android.net.Uri"),f=d.fromParts("package",r.getPackageName(),null);u.setData(f),u.putExtra("android.content.Intent.setFlags",l.FLAG_ACTIVITY_NEW_TASK)}else if(c.VERSION.SDK_INT<=8){u=new l(l.ACTION_VIEW);u.setClassName("com.android.settings","com.android.settings.InstalledAppDetails"),u.putExtra("com.android.settings.ApplicationPkgName",r.getPackageName()),u.putExtra("android.content.Intent.setFlags",l.FLAG_ACTIVITY_NEW_TASK)}r.startActivity(u),this.isShow=!1}else t.navigateBack({delta:1})}}))},onSelectClick:function(e){t.showActionSheet({itemList:["电话联系"],success:function(n){0==n.tapIndex&&t.makePhoneCall({phoneNumber:e.phone})}})},onSearchInput:function(t){var e=this,n=t.detail.value;if(this.isSearch=!0,""==n)this.contacts=JSON.parse(JSON.stringify(this.contactItems)),this.isSearch=!1;else{var i=[],o=[];o=JSON.parse(JSON.stringify(this.contactItems)),o.forEach(function(t,e){var o=[];if(t.contacts.forEach(function(t,e){for(var i=0;i<n.length;i++)if(-1!=t.name.indexOf(n[i])){var s=!1;o.find(function(e){e.phone==t.phone&&(s=!0)}),s||o.push(t)}}),o.length>0){o={letter:t.letter,contacts:o};i=i.concat(o)}}),setTimeout(function(){e.contacts=JSON.parse(JSON.stringify(i))},200)}}}};e.default=a}).call(this,n("6e42")["default"])},5809:function(t,e,n){"use strict";n.r(e);var i=n("1b7a"),o=n("9285");for(var s in o)"default"!==s&&function(t){n.d(e,t,function(){return o[t]})}(s);var a=n("2877"),r=Object(a["a"])(o["default"],i["a"],i["b"],!1,null,null,null);e["default"]=r.exports},9285:function(t,e,n){"use strict";n.r(e);var i=n("2963"),o=n.n(i);for(var s in i)"default"!==s&&function(t){n.d(e,t,function(){return i[t]})}(s);e["default"]=o.a}},[["5a8c","common/runtime","common/vendor"]]]);
});
