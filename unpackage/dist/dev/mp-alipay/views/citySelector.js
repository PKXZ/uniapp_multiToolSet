(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["views/citySelector"],{
...
//
//
var _default = { components: { uniIndexedList: _uniIndexedList.default }, data: function data() {return { list: _airport.default.list };}, mounted: function mounted() {var self = this;self.$nextTick(function () {if (self.$refs.citySearch.$el.clientHeight && self.$refs.dwCity.$el.clientHeight) {self.otherHeight = self.$refs.citySearch.$el.clientHeight + self.$refs.dwCity.$el.clientHeight;}});}, methods: { bindClick: function bindClick(e) {console.log('点击item，返回数据' + JSON.stringify(e));} } };exports.default = _default;
    ...
    [
      _c(
        ...
        [
          ...
          _c("button", { staticClass: "primary", attrs: { _hid: 3 } }, [])
        ],
        1
      ),
...
var _citySelector = _interopRequireDefault(__webpack_require__(/*! ./views/citySelector.vue */ "C:\\Users\\dchain\\Desktop\\githubProject\\uniapp_multiToolSet\\views\\citySelector.vue"));
...
//# sourceMappingURL=../../.sourcemap/mp-alipay/views/citySelector.js.map