<template>
	...
	<view class="main">
		<view class="container">
			<view class="qrimg">
				<view class="qrimg-i">
					<meQrcode v-if="ifShow" cid="qrcode1" ref="qrcode" :val="val" :size="size" :unit="unit" :background="background" :foreground="foreground" :pdground="pdground" :icon="icon" :iconSize="iconsize" :lv="lv" :onval="onval" :loadMake="loadMake" :usingComponents="true" @result="qrR" />
				</view>
				<view class="qrimg-i">
					<meQrcode v-if="ifShow" cid="qrcode2" ref="qrcode2" val="第二个二维码" :size="size" :onval="onval" :loadMake="loadMake" :usingComponents="true" @result="qrR" />
				</view>
			</view>
...
<script>
	...
	import meQrcode from "../components/common/meQrcode";
	export default {
		data() {
			return {
				ifShow: true,
